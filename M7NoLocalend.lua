...
local Window = OrionLib:MakeWindow({Name = "RM7Hubs | TPS STREET SOCCER", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
TabC:AddButton({
	...
	Callback = function()
      		setclipboard("https://discord.gg/tAUjZH7Q")
            print("link copied to clipoard")
  	end    
})

TabC:AddButton({
	Name = "في الديسكورد RM7 نسخ اسم ",
	Callback = function()
  setclipboard("2ivsl")
            print("link copied to clipoard")
  	end    

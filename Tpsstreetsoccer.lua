...
local Window = OrionLib:MakeWindow({Name = "AMC Hubs | TPS STREET SOCCER", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
TabC:AddButton({
	...
	Callback = function()
      		setclipboard("https://discord.com/invite/MrTjhJ7t")
            print("link copied to clipoard")
  	end    
})

TabC:AddButton({
	Name = "في الديسكورد AMC نسخ اسم ",
	Callback = function()
  setclipboard("o2rd")
            print("link copied to clipoard")
  	end    
